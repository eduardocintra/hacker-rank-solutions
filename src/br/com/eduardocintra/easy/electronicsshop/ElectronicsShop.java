...
public class ElectronicsShop {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[] firstLine = Arrays.stream(sc.nextLine().split("\\s")).mapToInt(Integer::parseInt).toArray();
        int[] keyboards = Arrays.stream(sc.nextLine().split("\\s")).mapToInt(Integer::parseInt).toArray();
