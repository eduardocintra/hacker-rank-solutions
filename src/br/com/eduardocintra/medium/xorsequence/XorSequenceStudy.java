    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if(acumulateXor == calculatedXor) {
                System.out.println(ANSI_GREEN+"i = " + format(i, 2) + "\txor = " + format(xor,2) + "\t0^"+ format(xor,2)+" = " + format(acumulateXor, 2) + "\tmod 8 = "+ format((i % 8), 2) + "\t my xor = " + format(calculatedXor,2)+ANSI_RESET);
            } else {
                System.out.println("i = " + format(i, 2) + "\txor = " + format(xor,2) + "\t0^"+ format(xor,2)+" = " + format(acumulateXor, 2) + "\tmod 8 = "+ format((i % 8), 2) + "\t my xor = " + format(calculatedXor,2));
